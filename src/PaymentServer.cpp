...
const QString BITCOIN_IPC_PREFIX("discrete:");

static QString ipcServerName()
{
    QString name("DiscreteWallet");
...
PaymentServer::PaymentServer(QApplication* parent) : QObject(parent), saveURIs(true)
{
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start discrete: click-to-pay handler");
    else
...
{
    // clicking on discrete: URLs creates FileOpen events on the Mac:
